...
from models.data_loaders import DrugResistanceDataset_Fingerprints, SampleEmbDataset, DrugResistanceDataset_Fingerprints2
...
if __name__=="__main__":
    ...
    parser.add_argument("--spectra_df", type=str,
                        default="../data/DRIAMS-B/spectra_binned_6000_2018_reprocessed.csv")
