...
if __name__=="__main__":
    ...
    parser.add_argument("--experiment_group", type=str, default="ResAMR_random_split_fprint")
    ...
    parser.add_argument("--fingerprint_size", type=int, default=2601)
    ...
    parser.add_argument("--sample_embedding_dim", type=int, default=128)
