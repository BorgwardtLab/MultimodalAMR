...
def main(args):
    ...
    ft_train_df, ft_val_df = dsplit.baseline_train_test_split(finetune_df, test_size=0.4, random_state=args.seed)
    ...
    trainer2 = pl.Trainer(devices="auto", accelerator="auto", default_root_dir=output_folder, max_epochs=100, callbacks=callbacks,
                         logger=tb_logger, log_every_n_steps=3,
                         limit_train_batches=20, limit_val_batches=10, #limit_test_batches=5
                         )
    ...
    test_df["predicted_logits"] = experiment2.test_predictions
...
if __name__=="__main__":
    ...
    parser.add_argument("--experiment_name", type=str, default="resMLP")
    parser.add_argument("--experiment_group", type=str, default="baseline_comp")
    ...
    parser.add_argument("--splits_file", type=str,
                        default="outputs/AMR_baseline_splits.json")
